      ...
      <View style={styles.modalBg}>
        <View style={styles.modal}>
          <View style={styles.modalTopBar}>
            <Text style={styles.headerText}>{Strings.upload_image}</Text>
          ...
          <View style={styles.optionArea}>
            ...
            <TouchableOpacity
              ...
              <Image source={Images.gallery_icon} style={styles.galleryIcon} />
              <Text style={styles.uploadBtnText}>{Strings.gallery}</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  modalIcon: {
    ...
    height: ScaleSize.very_large_icon + 40,
    width: ScaleSize.very_large_icon + 40,
  },
  headerText: {
    fontFamily: AppFonts.semi_bold,
  ...
  closeBtn: {
    backgroundColor: Colors.textinput_bg,
    padding: ScaleSize.spacing_small,
    borderRadius: ScaleSize.spacing_very_small,
  },
});
