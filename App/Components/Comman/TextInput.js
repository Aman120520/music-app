      ...
      >
        ...
        <TextInput
          ...
          style={[
            ...
            {
              color: Colors.black,
              fontFamily: isFocused ? AppFonts.bold : AppFonts.medium,
        ...
        {props.secureTextEntry && (
          ...
          >
            <Image
              style={[styles.hideIcon, { tintColor: Colors.primary }]}
              source={isSecureEntry ? Images.unhide_icon : Images.hide_icon}
            />
          </TouchableOpacity>
        )}
      </Animated.View>
